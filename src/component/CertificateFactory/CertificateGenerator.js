const fs = require('fs');
const {CertificateGeneratorFactory} = require('./CertificateGeneratorFactory');
...
class CertificateGenerator {
    ...
    run() {
        ...
        const certificateGenerator = CertificateGeneratorFactory.getCertificateGenerator(this.options, this.hostname, this.certsDir);
...
const certGen = new CertificateGenerator('-f','./certs/example.req', './certs');
certGen.run();
